...
const Cancelticket = () => {
  ...
  const { data } = UseSingelTicket(id as string);
  const geteventname = data?.event_info.event_name;
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                ...
                <Typography fontSize="14px">
                  {data?.event_info?.event_date
                    ? new Date(data.event_info.event_date).toLocaleString(
                        undefined,
                        {
                          year: "numeric",
                          month: "long",
              ...
              >
                ...
                <Typography fontSize="14px">
                  {data?.event_info.event_location.venue}
                </Typography>
              </Stack>
            </Box>
            ...
            >
              ...
              <strong>PERMANENT</strong>. All Event data, attendees, and
